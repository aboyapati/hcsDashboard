...
var terminationResources_App = angular.module('terminationResources_App',['scrollable-table'])
...
.controller('terminationResourcesCtrl', function($scope, $timeout, $window, Data, Comparators) {
    ...
    $scope.visibleProjects = terminationResources_txt;
