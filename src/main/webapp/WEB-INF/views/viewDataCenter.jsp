...
<div class="editconnection">
	...
	<form id="view_provisioning_form">
		<h3 class="edit_title">View Data Center</h3>
		...
		<table class="edit_connection_table">
			...
			<tr>
				...
				<td class="editconnection_buttons">
					<button style="background-color: transparent;border: 0px; width: 80px;height: 35px;" type="reset" class="view_cancel_button" data-dismiss="modal"></button>
				</td>
			</tr>				
		</table>
	</form>
